...
export class QueryClientImpl {
    ...
    Leaderboard(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "Leaderboard", data);
    ...
    PlayerInfo(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "PlayerInfo", data);
    ...
    PlayerInfoAll(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "PlayerInfoAll", data);
    ...
    CanPlayMove(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "CanPlayMove", data);
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "StoredGame", data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "StoredGameAll", data);
    ...
    NextGame(request) {
        ...
        const promise = this.rpc.request("BenWolfaardt.checkers.checkers.Query", "NextGame", data);
