...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/canPlayMove
   */
  queryCanPlayMove = (
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/canPlayMove`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryLeaderboard = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetLeaderboardResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/leaderboard`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/nextGame
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/nextGame`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/playerInfo
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<CheckersQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/playerInfo`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/playerInfo/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/playerInfo/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/storedGame
   */
  queryStoredGameAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/storedGame`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/BenWolfaardt/checkers/checkers/storedGame/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/BenWolfaardt/checkers/checkers/storedGame/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
